  ...
  return (
    <div data-dial-init className="fixed end-6 bottom-6 group">
      ...
      <button
        ...
        aria-expanded="false"
        className="flex items-center justify-center text-white bg-primary-SpeedDial-normal rounded-full w-14 h-14 hover:bg-blue-800 dark:hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:outline-none dark:focus:ring-blue-800"
      >
        <svg
          width="24"
          height="24"
